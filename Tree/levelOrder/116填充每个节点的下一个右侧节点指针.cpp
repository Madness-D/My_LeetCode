/* ************************************************************************
> File Name:		116填充每个节点的下一个右侧节点指针.cpp
> Author:		bwding
> Mail:		dingbuowen@outlook.com
> Created Time:		2022-05-24 23:34:25
> Link:		https://leetcode.cn/problems/populating-next-right-pointers-in-each-node/
> Description:		给定一个完美二叉树 ，其所有叶子节点都在同一层，每个父节点都有两个子节点。填充它的每个next指针，让这个指针指向其下一个右侧节点。如果找不到下一个右侧节点，则将 next 指针设置为 NULL
*************************************************************************/
#include<bits/stdc++.h>
using namespace std;
